 ...
 */
public class EndHighSpeedModeMessage extends HighSpeedModeMessage {
    public EndHighSpeedModeMessage(MedtronicCnlSession pumpSession) throws EncryptionException, ChecksumException {
